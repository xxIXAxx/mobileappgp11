...
public class MainActivityLarry extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupnewgame(){
        ...
        for(int i = 0; i < shuffledrawableids.size();i++){
            ...
            cardinfoLarry cardinfo = new cardinfoLarry(imageviewid,drawableid);
    ...
    cardinfoLarry cardinfo1 = null;
    int matchcount = 0;
    boolean iswaiting = false;

    private void covercard(cardinfoLarry cardinfo){
    ...
    public void onClick(View v) {
        if(!iswaiting){
            ...
            cardinfoLarry cardinfo = (cardinfoLarry) imageView.getTag();
